...
export default function PhysicsButton({ darkMode, onClick }) {
  const [pos, setPos] = useState({ x: typeof window !== 'undefined' ? window.innerWidth - 60 : 500, y: -100 });
  ...
  const lastPos = useRef({ x: typeof window !== 'undefined' ? window.innerWidth - 60 : 500, y: -100 });
